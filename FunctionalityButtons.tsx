...
export const FunctionalityButtons = () => {
  return (
    <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm bg-white/30 backdrop-blur-md bg-white/30 backdrop-blur-md bg-white/30 backdrop-blur-md">
